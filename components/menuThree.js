  ...
  return (
        ...
        <DropdownMenu>
            <DropdownMenuTrigger asChild className='menu-icon-blue'>
                <Button variant="transperant" aria-label='menu' className='p-0'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 24 24" fill="none" stroke="" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-menu">
                    <line x1="10" x2="20" y1="12" y2="12" className='gradient-btn'/>
                    <line x1="4" x2="20" y1="6" y2="6" className='gradient-btn'/>
                    <line x1="4" x2="20" y1="18" y2="18" className='gradient-btn'/>
                    </svg>
                </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent>
