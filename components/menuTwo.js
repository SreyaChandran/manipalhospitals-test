        ...
        <NavigationMenuList>
            ...
            <NavigationMenuItem>
                <Link href="#" legacyBehavior passHref aria-label='podcast'>
                    <NavigationMenuLink aria-label='podcast' className='h-[28px] bg-white text-primary text-[13px] font-semibold font-primary flex flex-row gap-[2px] px-[2px] md:px-[8px] rounded-full items-center'>
