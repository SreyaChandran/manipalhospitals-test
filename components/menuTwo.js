...
const MenuTwo = () => {
  return (
    <NavigationMenu>
        <NavigationMenuList>
            <NavigationMenuItem>
                <NavigationMenuTrigger className='h-[28px] text-primary text-[13px] font-primary flex font-semibold flex-row gap-[2px] px-[4px] rounded-full'>
            ...
            <NavigationMenuItem className='max-[768px]:hidden'>
                <Button variant="transperant" className='p-0'>
                    <Link href="#" legacyBehavior passHref>
                    <NavigationMenuLink className='h-[28px] bg-white text-primary text-[13px] font-semibold font-primary flex flex-row gap-[2px] px-[8px] rounded-full items-center'>
