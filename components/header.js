...
const Header = () => {
  return (
    <div className='h-[120px] w-full flex flex-col items-center gap-0 justify-between fixed top-0 left-0'>
        ...
        <div className='navbar-sec1 header-top px-1 md:px-4 lg:px-10 xl:px-16 2xl:px-20 w-full max-w-[1300px] 2xl:w-[1300px] mx-auto h-full flex flex-row items-center justify-between'>
          <div className='w-[240px] max-[767px]:w-[200px] max-[575px]:hidden'>
            <Image src={logo1} alt="Manipal Hospitals" />
          </div>
          <Link href="#" className='btn-lifesOn py-2 px-4 border-[1px] rounded border-[#fff] bg-[#fff] w-[120px] max-[767px]:w-[100px] min-[576px]:hidden'>
          ...
          <div className='flex flex-row items-center justify-end gap-2'>
            ...
            <Button variant="outline" className='min-[768px]:hidden bg-white text-primary text-[13px] font-semibold font-primary flex flex-row gap-2 px-[10px] rounded-full items-center m-0 outline-0'>
        ...
        <div className='nav-bar min-h-[40px] w-full max-w-[1440px] 2xl:w-[1440px] mx-auto border-b-[3px] border-b-primary'>
          <div className='w-full max-w-[1300px] 2xl:w-[1300px] mx-auto px-1 md:px-4 lg:px-10 xl:px-16 2xl:px-20 flex items-center justify-center'>
            <div className='w-[240px] max-[767px]:w-[200px] min-[576px]:hidden'>
              <Image src={logo1} alt="Manipal Hospitals" />
            </div>
